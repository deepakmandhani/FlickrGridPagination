...
import com.example.flickrsimulation.R
import com.example.flickrsimulation.common.Instance
import com.example.flickrsimulation.common.Utils
import com.example.flickrsimulation.model.Photo
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpAdapter(list: List<Photo>) {
        ...
        val layoutManager =
            GridLayoutManager(this, Utils.COLUMN_NO, GridLayoutManager.VERTICAL, false)
        ...
        rv_photos.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (!isLoading && !isLastPage) {
                    if ((visibleItemCount + firstVisibleItemPosition) >= totalItemCount - Utils.REFRESH_BEFORE_LAST
    ...
    private fun searchFlickrPhotos() {
        if (Utils.isInternetConnected(this@MainActivity)) {
            ...
            viewModel.searchFlickrPhotos(this.searchFor, this.nextPage)
        } else {
